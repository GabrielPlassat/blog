...
Et on ne peut pas cartographier toute la planète" [@PSA_news]() concernant la voiture autonome => en êtes vous sûr ? [http://t.co/2IUnVuxYNA]()

 — Gabriel Plassat (@TdF__ademe) [8 Janvier 2014]() 

**Et la puissance de Twitter a fait le reste** ... Réaction de Waze France "**Mais si, on est en train de le faire**"

 

"Et on ne peut pas cartographier toute la planète" 

Puis PSA "**Jusqu'à quel niveau de précision ?**" 

 

[@TdF__ademe]() bien-sûr on peut -) mais jusqu'à quel niveau de précision ?

 — PSA Peugeot Citroën (@PSA_news) [8 Janvier 2014]() 
...
- Connaissance du contexte, de l'environnement, des [**territoires** ](): Google map, Street view, Google glass, [**Waze**](), [**Uber**]() 
