...
- **[Gamification](http://www.kesako-le-blog.fr/2012/08/22/pourquoi-la-gamification-ne-fonctionne-pas/)** : imbriquer le réel et le virtuel. Rien ne sera comment avant, les expériences d’achat seront totalement mixées (voir l’**[exemple](http://www.lsa-conso.fr/les-galeries-lafayette-vont-digitaliser-haussmann,129449)** des Galeries Lafayette). Le jeu permet de faire remonter d’autres expériences utilisateurs, de rester dans l’Univers de la Marque, d’identifier les pionniers et les récompenser. 
- **[Réputation](http://www.wired.co.uk/magazine/archive/2012/09/features/welcome-to-the-new-reputation-economy?page=all)** et **[monnaie libre ](http://www.lesechos.fr/entreprises-secteurs/finance-marches/actu/0202117661586-la-monnaie-virtuelle-cree-de-nouveaux-systemes-d-echange-354557.php)**: Identifier les invités futurs leaders d’opinion, pondérer les expériences, récompenser les meilleurs pour qu’ils deviennent ambassadeurs de l’entreprise. **[Klout](http://klout.com/home)** propose déjà, si vous avez un indice d’influence (calculé à partir de l’audience de vos articles) supérieur à X, des bons de réduction dans votre domaine : Influencer les influenceurs. Cet **[article](http://www.wired.co.uk/magazine/archive/2012/09/features/welcome-to-the-new-reputation-economy?page=all)** de Wired détaille la nouvelle économie de la réputation à travers de nombreux exemples. 
