...
o     Des gestionnaires d’infrastructures (appelé **[réseau de distribution pour l’électricité, ERDF](http://fr.wikipedia.org/wiki/Gestionnaire_du_Reseau_de_Distribution)** qui exploite, entretient le réseau) qui sont très variés pour les transports : département, communes, état, sociétés privés (autoroutes, gares …).

 

o     Des **[responsables d’équilibres](http://fr.wikipedia.org/wiki/Responsable_d)**, **[RTE](http://fr.wikipedia.org/wiki/Reseau_de_transport_d)** dans le cadre de l’électricité, qui coordonne l’ensemble des acteurs ; gestion équilibre offre/demande, conduite du réseau, gestion du marché de l’électricité.
...
o     Une commission de régulation (**[CRE](http://fr.wikipedia.org/wiki/Commission_de_regulation_de_l)** dans le cadre de l’électricité) qui concourt, au bénéfice des consommateurs finals, au bon fonctionnement des marchés de l'électricité.
...
Comme le particulier sera incapable de gérer cette complexité temps réel, deux nouveaux rouages seront nécessaire : des opérateurs de mobilité, et des **[assistants personnels de mobilité](/2010/02/personnal-travel-assistant-cisco.html)** qui feront le lien , place de marché => opérateur => particulier.
