...
Tout ceci avait été abordé dans un article écrit il y a 2 ans ([**le voici**](/2010/10/metanote-tdf-n8-les-ports-le-fret-et-le-transport-de-marchandises.html)). Tout ceci peut devenir réalité dans une ou 2 années avec des conséquences non négligeable en matière de transport. [**IBM**](http://venturebeat.com/2012/07/01/ibm-launches-augmented-reality-shopping-app/) y travaille aussi : 

 

[![](/assets/images/old/6a0120a66d2ad4970b0176160769d5970c-500wi.jpg)](/assets/images/old/6a0120a66d2ad4970b0176160769d5970c-pi.jpg)

 

En mettant en oeuvre ce type d'outil, et en les maîtrisant, le consommateur fera mentir [**E.Berney** ](/2011/10/le-consommateur-du-futur-revolution.html)(auteur de Propaganda), réduira l'asymétrie d'informations avec les vendeurs/producteurs, et augmentera ses connaissances, ses savoirs, et donc son autorité (augere", savoir augmenté). Le consommateur peut donc "[**reprendre la main**]()".
