...
date: 2010-03-01 11:52:52 +0100
categories: []
tags: ['autorité des transports', 'avego', 'citoyen', 'connectivité', 'données réelles', 'internet', 'open source', 'partage de données']
---

C’est une première en Bretagne, et en France : une entreprise privée à vocation de service public fait le choix de partager ses données brutes. Keolis Rennes a décidé de mettre une partie de ses données collectées en interne, en accès libre sur le web (films et nombreuses interviews, voir [**ici**](http://www.web-patron.com/2010/02/11/keolis-ouvre-ses-donnees/)).
...
L’ouverture des données représente davantage qu’une simple évolution libérale – au sens américain du terme- de l’usage des données privées ou publiques . C’est un bouleversement de l’ordre établi, et un pari sur le futur. Ce point a déjà été largement abordé sur ce blog, tant au niveau de l'autorité (voir **[ici](/2010/01/open-air-government.html)**), que du citoyen (voir **[ici](/2010/01/code-for-america-connecting-city-and-web-20-talent.html)**) ou des usages complémentaires (voir **[ici](/2010/02/avego-realtime-ridesharing-for-the-iphone-generation.html)**).
