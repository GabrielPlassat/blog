...
Le véhicule autonome (niveau 4, lire l'article **[Robotisation, automatisation des véhicules en 2020](/2013/09/nissan-et-daimler-sengagent-a-commercialiser-des-voitures-autonomes-en-2020-risques-et-opportunites.html)**) fixe un objectif possible. La robotisation ne fait que commencer pour améliorer la rentabilité des services. 

 

Cette mutation s'observe tous les jours (voir toutes les **[MétaNotes](/les-metanotes-tdf-transports-du-futur)**). A une rupture attendue sur des technologies de propulsion se substitue une mutation servicielle des usages accélérée par l'introduction d'un nouveau liant simplificateur : le numérique. **Grâce à cette mutation servicielle, de nouvelles énergies, dont l'électricité, deviennent possibles**. Quelle sera la place des industriels automobiles historiques dans les futures chaînes de valeur ? 
