...
“Modern buses are a key component of public transportation which has a major impact on the quality of life—including the environment, air pollution and public health—for millions of people,” EMBARQ Senior Transport Engineer [Dario Hidalgo](http://www.wri.org/profile/dario-hidalgo) said in a [press release](http://www.embarq.org/en/news/10/09/29/embarq-releases-report-summarizing-lessons-learned-major-bus-improvements-latin-americ). “Increasingly, these cities are upgrading or even transforming their public transport systems to better serve the needs of their populations and the environment.”
...
Despite initial problems, the bus systems proved to be very resilient.
 ...
 [Brt report](http://www.slideshare.net/transportsdufutur/brt-report) View more [documents](http://www.slideshare.net/) from [transportsdufutur](http://www.slideshare.net/transportsdufutur).
