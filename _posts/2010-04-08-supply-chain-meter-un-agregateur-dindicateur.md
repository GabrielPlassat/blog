...
A l’avenir, le client final ou intermédiaire aura accès à un grand nombre **d’indicateurs**. Les professionnels sauront les gérer, les utiliser, les exploiter grâce à des outils adaptés comme le Supply Chain Meter. De son coté, le consommateur devra lui aussi disposer d’outils d’aide. L’interview de Peter Norvig, directeur du moteur de recherche Google à la revue **[Nature](http://www.nature.com/nature/journal/v463/n7277/full/463026a.html)**, est particulièrement intéressante.
...
Accessible via Internet, le **référentiel [Supply Chain Meter](http://www.supplychain-meter.com/SupplyChainMeter/SUPPLYCHAINMETER_WEB/FR/Outils_et_services__acces_referentiel.awp)** est un concentré d’expertise et d’innovation conçu pour toutes les entreprises.
