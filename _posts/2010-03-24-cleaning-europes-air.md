...
There is now a single website which gives you ***all*** the information you need on Low Emission Zones in one place – and in your language! **www.lowemissionzones.eu** **.**   
...
1.		    Air pollution kills more people than road accidents. The human health damage from air pollution is estimated to cost Europe between €427 and €790 billion per year (reference: **[EU Cafe program](http://ec.europa.eu/environment/archives/cafe/general/keydocs.htm)** , also for the air quality deaths). 

 

2.		    More information on the EU air quality limit values can be found **[here ](http://lowemissionzones.eu/what-are-lezs--othermenu-32?start=10)**and also **[here](http://ec.europa.eu/environment/air/legis.htm)**. 

 

3.		    Air quality limit values are not expected to be met by most countries in the EU. Many countries are applying for time extensions for these Limit Values, but not many countries meet the extension requirements (see **[here](http://ec.europa.eu/environment/air/quality/legislation/time_extensions.htm)**). 

 

4.		    LEZs are often one of the most effective local measures to improve air quality to achieve cleaner, and healthier, air. They are implemented as part of a package of measures, tackling different sources. LEZs are one of the measures that must be considered when countries apply for extensions the EU air quality limit values : see **[here](http://eur-%20lex.europa.eu/LexUriServ/LexUriServ.do?uri=OJ:L:2008:152:0001:0044:EN:PDF)**. 
...
7.		    This project is funded by DG MOVE’s Clean Urban Transport Unit, see **[here](http://ec.europa.eu/transport/urban/index_en.htm)**

 

8.		    More information on the EU Sustainable Energy Week (can be found **[here](http://www.eusew.eu/index.cfm)**)  and DG MOVE’s Conference on Urban Mobility : **[here](http://www.eusew.eu/page.cfm?page=event_content&sby=3&sval=0&sd=40259&id=479)**,
