...
[**Le dernier service**](http://www.multicity.citroen.fr/voiture-mobilite/location-voiture-electrique-autrement/) qui s'intègre à cette palette est particulièrement innovant car il couple plusieurs approches : **la location d'un VE (C-zéro) et le partage entre particuliers**. Les 2 briques existaient, mais la fusion des 2 présente une synergie et permet de présenter un prix de location de 90 euro/mois.
...
Cette approche conforte une vision possible selon laquelle les principaux gains en matière d'énergie et de GES dans les transports viendront de cette 3ème voie du véhicule service (imaginé dès le départ [**MétaNote N°0**](/2009/11/le-passage-de-lobjet-vehicule-aux-services-de-mobilite-une-chance.html)) qui permet à la fois :
