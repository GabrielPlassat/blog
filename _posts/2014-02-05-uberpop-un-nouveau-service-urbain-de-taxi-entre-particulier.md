...
[![](/assets/images/old/6a0120a66d2ad4970b01a3fcb4eab7970b-500wi.png)](/assets/images/old/6a0120a66d2ad4970b01a3fcb4eab7970b-pi.png)
...
Il s'agit donc véritablement d'un nouveau service de mobilité. Et il faut être vigilant sur les termes utilisés pour éviter les confusions. Il ne s'agit d'autopartage puisque le propriétaire de la voiture la conduit. Mais il ne s'agit pas non plus de covoiturage. En effet, la [**définition du covoiturage**](http://www.feduco.org/le-senat-adopte-une-definition-legale-du-covoiturage/) récemment adoptée est la suivante :
