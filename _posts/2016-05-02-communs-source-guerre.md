...
[![osv](http://transportsdufutur.ademe.fr/assets/images/2016/05/osv.jpg)](http://transportsdufutur.ademe.fr/assets/images/2016/05/osv.jpg)Le projet Open Source Vehicle
...
La [**seconde partie de l'article**](http://transportsdufutur.ademe.fr/2016/05/communs-source-objets-guerre.html) portera sur les** stratégies industrielles qui utilisent les objets liens.
=======
_x000D_
...
**Inspirer et faire alliance permet d’être plus fort, d’aller plus vite, avec moins de ressource. Dans un monde ([VICA](/2013/07/10/light-foot-print-strategy/?s=VICA)) Vulnérable, Incertain, Complexe et surtout Ambigu, encore faut-il savoir le faire.**
...
- Indexer ou faire indexer les ressources ouvertes existantes (lien vers le wiki): données, logiciels, matériels. Pourquoi passer à côté, ou refaire quelque chose qui existe déjà ?_x000D_
	
- Identifier dans les projets en cours les ressources existantes ou à développer qui sont mutualisables. Pourquoi faire seul quelque chose qui n’est pas compétitif et qui peut être co-créer pour réduire ses dépenses et garantir à plusieurs les évolutions ? Cette ressource-là peut être ouverte ou pas selon la volonté des partenaires qui la développent._x000D_
...
- Le niveau d’ouverture : ouvert à fermé à une communauté_x000D_
	
- La logique : à priori (on sait à quoi va servir la ressource, elle est utile maintenant) / à posteriori (l’usage n’est pas connu à l’avance et la ressource peut être détournée de son usage prévu, elle sera utile “plus tard”)._x000D_
...
La ressource mise en œuvre par une communauté homogène ou hétérogène est un commun dès lors que ces derniers s’accordent sur des règles de gestion de la ressource pour la maintenir et la faire croitre. La ressource peut éventuellement être totalement ouverte. Dans tous les cas, elle constitue « **l’objet lien »** de la communauté qui se voit progresser à travers elle. L’objet lien rejoint bien sûr le prototype (lire l’article **[Ode au prototype](/2014/12/15/ode-au-prototype/)**) dont la réalisation permet au collectif **d’extérioriser** une idée, de la tester et de mesurer l’écart entre l’idée et les usages.
...
La [**seconde partie de l'article**](/2016/05/04/communs-source-objets-guerre/) portera sur les** stratégies industrielles qui utilisent les objets liens._x000D_
>>>>>>> 367d931c0bdecc6fccfc1ac0c8b8052776369bc4
**
