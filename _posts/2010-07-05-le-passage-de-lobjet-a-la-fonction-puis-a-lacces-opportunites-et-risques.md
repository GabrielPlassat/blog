...
A l'image de Google qui donne "accès" à l'information sur internet, **qui donnera accès aux mobilités 2.0** ? Le passage aux économies imbriquées de la *fonctionnalité, circulaire, de l'accès* est déjà enmarche. Dans cette nouvelle ère, la valeur économique vient désormais des concepts, des connaissances, des réseaux. Ces outils sont puissants, les risques existent de les détourner des objectifs décrits au départ.
