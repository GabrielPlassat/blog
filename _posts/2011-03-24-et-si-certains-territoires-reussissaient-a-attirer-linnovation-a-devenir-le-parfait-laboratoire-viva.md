...
La FING, dans le **[guide pratique](http://fing.org/?Guide-pratique-de-l-ouverture-des)** ci dessous, rappelle et détaille l’open data. Une opportunité ? un risque ? pourquoi faire ? pour qui ?
...
Michael Cross, journaliste au Guardian et initiateur du mouvement de l’open data ([Free our data](http://www.freeourdata.org.uk/)) en Europe est revenu sur la transparence permise par l’ouverture des données. Une transparence perceptible notamment depuis l’élection du nouveau gouvernement anglais.

 

François Bancilhon, CEO du site [Data-publica](http://www.data-publica.com/), un annuaire de données lancé en septembre dernier, expliquait quant à lui que l’ouverture des données allait permettre aux citoyens d’accéder en plus grand nombre à l’ensemble des données produites pour pouvoir «* optimiser les systèmes, de transport, d’énergie, de livraison de marchandises… et définir les stratégies du futur* ». Et ainsi anticiper des catastrophes sanitaires telles que la canicule de 2003 ou le blocage de l’autoroute A6 en décembre dernier.
...
**Pour aller plus loin, le rapport du Conseil d'Analyse Economique déjà identifié dans un précédent article (voir [ICI](/2010/10/creativite-et-innovations-dans-les-territoires-plus-dans-les-usages-que-dans-les-technologies.html))  détaille de nombreux points sur le rôle clé des territoires. **
