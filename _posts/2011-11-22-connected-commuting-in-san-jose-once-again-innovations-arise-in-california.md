...
Gotoo (in France) Waze and Roadify use same ideas: [**crowdsourcing**](), [**collective intelligence**](), new [**currencies **]()to reward cityzen to share a data. Here data and currencies are :

 
 
- parking place, time and [**streetcarma**]() 
- bus real time location, time and streetcarma 
- congestion, time 
 

**In Europe also, we have all individual bricks to build this kind of demonstration. Who will be able to reward properly the cityzen who share a strategic data ? [Free currencies]() can be the missing link ...**
